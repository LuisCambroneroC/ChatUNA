 ...
 */
public class act_Login extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     */
    private TareaIngresoUsuario mAuthTask = null;

    // UI references.
    private AutoCompleteTextView txtNumero;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtNumero = (AutoCompleteTextView) findViewById(R.id.txtNumero);
    ...
    private boolean mayRequestContacts() {
        ...
        if (shouldShowRequestPermissionRationale(READ_CONTACTS)) {
            Snackbar.make(txtNumero, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
    ...
    private void Ingresar() {
        ...
        String img = imgUsuario.getDrawable().toString();
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(act_Login.this,
                        android.R.layout.simple_dropdown_item_1line, emailAddressCollection);

        txtNumero.setAdapter(adapter);
    }
     ...
     * the user.
     */
    public class TareaIngresoUsuario extends AsyncTask<Void, Void, Boolean> {
